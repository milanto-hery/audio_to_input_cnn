...
class PreprocessingFlac:
    ...
    def create_dataset_flac(self, saved_segments, verbose):
        '''
        ...
        if verbose == True:
            ...
            print ('Audio path',self.audio_path+"*.flac")
        ...
        X_Narrow = X_Full[:,40:80, :]
        print('X_full shape', X_Full.shape)
        print('X_narrow shape', X_Narrow.shape)
        ...
        pickle_file = os.path.join(saved_segments, f"X_full.pkl")
        with open(pickle_file, 'wb') as file:
            pickle.dump(X_Full, file)
        
        pickle_file = os.path.join(saved_segments, f"X_narrow.pkl")
        with open(pickle_file, 'wb') as file:
            pickle.dump(X_Narrow, file)
        ...
        with open(pickle_file, 'wb') as file:
         ...
         # zip_compression
        # --------------------------------------------------------------------------------------------------------------------------
        #zip_location_1 = os.path.join(self.species_folder+'/'+saved_segments, f"X_narrow"+".zip")
        #text_file_1 = os.path.join(self.species_folder+'/'+saved_segments, f"X_narrow"+".pkl") 
        ...
        # ------------------------------------------------------------------------------------------------
        return X_Full, X_Narrow, Y_calls
