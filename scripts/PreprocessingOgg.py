...
class PreprocessingOgg:
    ...
    def create_dataset_ogg(self, saved_segments, verbose):
        '''
        ...
        if verbose == True:
            ...
            print ('Audio path',self.audio_path+"*.ogg")
        ...
        pickle_file = os.path.join(saved_segments, f"X_ogg.pkl")
